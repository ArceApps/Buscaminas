...
public class VPrincipal extends JFrame {
	...
	/**
	 * Convertimos mina en una imagen. creamos una imagen nueva d�ndole las
	 * dimensiones que queramos a la antigua. Lo mismo con las dem�s im�genes.
	 */
	...
	public JMenuBar menu() {
		...
		this.menuEdicion = new JMenu("Edici�n");
		this.menuAyuda = new JMenu("Ayuda");
		this.menuEstadisticas = new JMenu("Estad�sticas");
	...
	public void resetearBotones(Controlador c) {
		...
		for (int i = 0; i < filas; i++) {
			for (int j = 0; j < columnas; j++) {
				// Quito el controlador de los botones. para a�adirlos de nuevo con
